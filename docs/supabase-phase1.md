...
- Environment template in [`/.env.example`](/C:/Users/redacted/Downloads/pmn-framework/.env.example)
- Supabase client scaffold in [`/src/lib/supabase.js`](/C:/Users/redacted/Downloads/pmn-framework/src/lib/supabase.js)
- Backend data helpers in [`/src/lib/pmn-backend.js`](/C:/Users/redacted/Downloads/pmn-framework/src/lib/pmn-backend.js)
- SQL schema with RLS in [`/supabase/schema.sql`](/C:/Users/redacted/Downloads/pmn-framework/supabase/schema.sql)

## What still needs to happen in Supabase

1. Create a Supabase project.
2. Open the SQL editor and run [`/supabase/schema.sql`](/C:/Users/redacted/Downloads/pmn-framework/supabase/schema.sql).
