...
READ THIS FIRST IF YOUR FETCHER TRUNCATES. This file is about 2.4 MB (roughly
half a million tokens); most fetchers stop long before the end, usually inside the glossary.
